...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    final url =
        'https://shopsapp-e49b2.firebaseio.com/products.json?auth=$authToken&$filterString';
    try {
      ...
      final favoritesUrl =
          'https://shopsapp-e49b2.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product prod) async {
    final url =
        'https://shopsapp-e49b2.firebaseio.com/products.json?auth=$authToken';
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          'https://shopsapp-e49b2.firebaseio.com/products/$id.json?auth=$authToken';
      await http.patch(
        url,
        body: json.encode(
          {
